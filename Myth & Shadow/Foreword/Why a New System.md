...
So my request to the ether is, if you make **an ability that players can choose** when creating characters / levelling up, make it clear what it does. If it's unclear, then I need to use my time to design the ability for you when the player, understandably, doesn't understand the text. I'd rather you just not include that ability as a choice if you can't define it.
...
I like Shadowdark more than Knave 2e from a GM perspective, but I have some big issues with it.
...
2. Character progression offers the players almost no choices
	1. Aside from spellcasters choosing spells, it's all random. Making it not random has other issues because it's not balanced around that. 
	2. Moreover, it feeds into my classes issue I discussed at the beginning, what does a strong wizard look like? Why can't they wear armor or wield a sword? I know it's for balance purposes, but as a player I would find it boring and limiting. 
	3. I believe you can give players meaningful choices at level up without subclass / feats etc. Just make ability scores matter more. Treat them like mini classes. Now players have total freedom to build a character as the game goes on without special abilities that invalidate the fun challenges the GM creates.
