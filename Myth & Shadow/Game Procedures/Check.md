...
*Since AC is changed to be much lower, this doesn't have the undesirable effect that you can't even hit higher level enemies and vice versa ala 3e / pathfinder. It does mean that if have low martial stats as a high level caster, using your backup crossbow from level 1 against the Vampire Lord is a really bad idea, because yeah, you might not even hit this fool, they're the Vampire Lord. Cast a spell you d*