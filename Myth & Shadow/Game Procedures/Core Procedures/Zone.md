...
2. A [Ranged Attack](../Combat/Ranged%20Attack.md) and [Spells](../../Magic/Spells.md) can target anything the creature can see in their current zone or a number of zones away according to the range specified.
