...
- If any player succeeds, they spot the creature at a distance of about 200 feet.
	...
	- If any player succeeded by 5 or more, the creature is unaware of them.
		- Staying undetected for an extended time requires stealth ([Dexterity](../../Player%20Characters/Chosen%20Statistics/Dexterity.md)) [Checks](Core%20Procedures/Check.md) from each PC within sight range of the creature.
